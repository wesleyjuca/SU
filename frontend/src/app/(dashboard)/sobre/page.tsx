...
const AREAS: { titulo: string; recursos: Recurso[] }[] = [
  {
    titulo: "Jurídico",
    recursos: [
      { icon: Scale, nome: "Processos & Prazos", desc: "Cadastro, captura por OAB, andamentos, alertas e cálculo automático de prazo (dias úteis, feriados forenses e recesso).", estado: "operacional" },
  ...
  },
  {
    ...
    recursos: [
      ...
      { icon: Users, nome: "Clientes (CRM) & LGPD", desc: "Gestão de clientes/leads, funil de vendas (oportunidades com forecast) e controle de consentimento.", estado: "operacional" },
