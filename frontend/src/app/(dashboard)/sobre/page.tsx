...
const ROADMAP: { fase: string; itens: string; estado: Estado }[] = [
  ...
  { fase: "Multi-unidade & SaaS", itens: "P1 entregue: isolamento por escritório + provisionamento de escritórios/unidades (SUPERADMIN) · P2: cobrança mensal (manual) · P3: gateway de pagamento e subdomínios", estado: "parcial" },
];
